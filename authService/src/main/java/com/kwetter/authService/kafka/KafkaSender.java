package com.kwetter.authService.kafka;

import com.kwetter.authService.kafka.message.KafkaLoggingMessage;
...
public class KafkaSender {
    ...
    public void sendKafkaLogging(String content, KafkaLoggingType loggingType) {
        kafkaTemplateLogging.send("logging", new KafkaLoggingMessage("AuthService", content, loggingType));
    }
}
